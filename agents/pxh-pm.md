...
## Liên kết
T2: `runtime/layers/02-orchestration.md` | Contracts: `runtime/contracts/README.md` | Policies: `runtime/policies/retry.md`, `runtime/policies/recovery.md`, `runtime/policies/reflection.md` | Workflows: `workflows/company.workflow.md` | Context: `_shared/context-budget.md`
