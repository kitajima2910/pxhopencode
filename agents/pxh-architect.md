...
## Liên kết
Worker: `runtime/layers/03-worker.md` | Orchestration: `runtime/layers/02-orchestration.md` | ADR template: `_shared/templates/adr.md` | Context: `_shared/context-budget.md`
