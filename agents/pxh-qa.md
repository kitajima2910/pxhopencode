...
## MEMORY REFLECTION
- `node runtime/bin/node runtime/bin/persist.mjs append bugs '{"id":"bug_...","type":"...","steps":"..."}'`
- `node runtime/bin/node runtime/bin/persist.mjs reflect patterns test_pattern "{desc}"`
