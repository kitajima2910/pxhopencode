...
| 2026-07-27 | v82.4 | **start.bat** — thêm `start.bat` để chạy init từ cmd/double-click, không cần gõ PowerShell command. README cập nhật cài đặt 3 dòng: clone → start.bat. |
