...
export type TokenType =
  ...
  | 'path' | 'command' | 'symbol' | 'whitespace'
  | 'code_block' | 'language' | 'framework'
  | 'library' | 'file_extension' | 'intent_word'
  | 'constraint_word' | 'filler' | 'technical_term'
  | 'unknown';
...
export type LexicalCategory =
  | 'intent' | 'constraint' | 'framework' | 'language'
  | 'platform' | 'library' | 'file_path' | 'command'
  | 'action' | 'technical_term' | 'project_name'
  | 'filler' | 'unknown';
